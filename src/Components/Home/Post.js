  ...
  return (
    <div className="post">
      <div className="post-header">
        ...
        <div
          className="delete"
          onFocus={() => setShowDelete(!showDelete)}
          onBlur={() => setShowDelete(!showDelete)}
        >
          {showDelete && (
          ...
          <MoreVertRoundedIcon
            ...
            // onFocus={() => setShowDelete(!showDelete)} onBlur={() => setShowDelete(!showDelete)}
          />
        </div>
      </div>
